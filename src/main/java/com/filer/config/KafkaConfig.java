...
public class KafkaConfig {
    ...
    public NewTopic fileConversionTopic() {
        return TopicBuilder.name(TOPIC_FILE_CONVERSION).partitions(3).replicas(1).build();
    }

    @Bean
    public NewTopic conversionResultTopic() {
        return TopicBuilder.name(TOPIC_CONVERSION_RESULT).partitions(3).replicas(1).build();
    }
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "filer-group");
